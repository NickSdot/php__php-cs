...
try {
    ...
    echo "RuntimeException thrown: " . $e::class . ": " . $e->getMessage() . PHP_EOL;
}
try {
    $m->key();
} catch(RuntimeException $e) {
...
try {
    ...
    echo "InvalidArgumentException thrown: " . $e::class . ": " . $e->getMessage() . PHP_EOL;
}
...
try {
    ...
    echo "TypeError thrown: " . $e::class . ": " . $e->getMessage() . PHP_EOL;
}
...
RuntimeException thrown: RuntimeException: Called current() with non valid sub iterator
RuntimeException thrown: RuntimeException: Called key() with non valid sub iterator
...
InvalidArgumentException thrown: InvalidArgumentException: Sub-Iterator is associated with NULL
...
TypeError thrown: TypeError: MultipleIterator::attachIterator(): Argument #2 ($info) must be of type string|int|null, stdClass given
-- Associate with duplicate value --
InvalidArgumentException thrown: InvalidArgumentException: Key duplication error
